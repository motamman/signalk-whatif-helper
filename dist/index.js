...
const PutHandlerManager_1 = require("./PutHandlerManager");
const WebSocketServer_1 = require("./WebSocketServer");
const PLUGIN_ID = 'signalk-whatif-helper';
module.exports = (app) => {
    let pathManager;
    let putHandlerManager;
    let wsServer;
    const plugin = {
        id: PLUGIN_ID,
        name: 'What-If Helper',
        ...
        start: async (config) => {
            ...
            // Initialize managers
            pathManager = new PathManager_1.PathManager(app);
            putHandlerManager = new PutHandlerManager_1.PutHandlerManager(app, pathManager);
            wsServer = new WebSocketServer_1.WebSocketServer(app, pathManager);
            // Get the HTTP server for WebSocket
            const server = app.server || app._server;
            if (server) {
